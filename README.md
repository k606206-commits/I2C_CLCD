...
int main(void)
{
  ...
  LCD_INIT();
  LCD_XY(0, 0) ; LCD_PUTS((char *)"LCD Display Temperature");
...
```C
  ...
  //	  printf("ADC1_temperature: %d \n", adc1);
  	  ...
  	  printf("temperature:%d,%.1lf℃ \n",adc1, temp);
  	 sprintf(lcd_buf, "TEMP: %.1f%cC", temp,0xDF);
...
#endif /* USE_FULL_ASSERT */
## ---오실로스코프 측정값----
<img width="706" height="170" alt="129" src="https://github.com/user-attachments/assets/df6e745d-f63b-48ef-86e1-366eb8f5a993" />
